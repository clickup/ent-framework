[@slapdash/ent-framework](../README.md) / [Exports](../modules.md) / SQLRunnerDeleteWhere

# Class: SQLRunnerDeleteWhere<TTable\>
...
- [`SQLRunner`](SQLRunner.md)<`TTable`, [`DeleteWhereInput`](../modules.md#deletewhereinput)<`TTable`\>, `string`[]\>

  ↳ **`SQLRunnerDeleteWhere`**

## Constructors

### constructor

• **new SQLRunnerDeleteWhere**<`TTable`\>(`schema`, `client`)
...
[packages/ent-framework/src/sql/SQLQueryDeleteWhere.ts:24](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/sql/SQLQueryDeleteWhere.ts#L24)
...
[packages/ent-framework/src/sql/SQLQueryDeleteWhere.ts:23](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/sql/SQLQueryDeleteWhere.ts#L23)

___

### runBatch

• **runBatch**: `undefined` = `undefined`
...
[packages/ent-framework/src/sql/SQLQueryDeleteWhere.ts:56](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/sql/SQLQueryDeleteWhere.ts#L56)
...
[packages/ent-framework/src/sql/SQLQueryDeleteWhere.ts:22](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/sql/SQLQueryDeleteWhere.ts#L22)
...
[packages/ent-framework/src/sql/SQLQueryDeleteWhere.ts:28](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/sql/SQLQueryDeleteWhere.ts#L28)

___

### runSingle

▸ **runSingle**(`input`, `annotations`): `Promise`<`string`[]\>
...
[packages/ent-framework/src/sql/SQLQueryDeleteWhere.ts:34](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/sql/SQLQueryDeleteWhere.ts#L34)
