...
- [`SQLRunner`](SQLRunner.md)<`TTable`, [`SelectByInput`](../modules.md#selectbyinput)<`TTable`, `TUniqueKey`\>, [`Row`](../modules.md#row)<`TTable`\>[]\>
...
• **new SQLRunnerSelectBy**<`TTable`, `TUniqueKey`\>(`schema`, `client`, `fields`)
...
| `fields` | [`FieldOfPotentialUniqueKey`](../modules.md#fieldofpotentialuniquekey)<`TTable`\>[] |
...
| Name | Type |
| :------ | :------ |
| `input` | [`SelectByInput`](../modules.md#selectbyinput)<`TTable`, `TUniqueKey`\> \| [`Row`](../modules.md#row)<`TTable`\> |
...
| Name | Type |
| :------ | :------ |
| `inputs` | `Map`<`string`, [`SelectByInput`](../modules.md#selectbyinput)<`TTable`, `TUniqueKey`\>\> |
| `annotations` | [`QueryAnnotation`](../interfaces/QueryAnnotation.md)[] |
