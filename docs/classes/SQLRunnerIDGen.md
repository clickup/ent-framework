[@slapdash/ent-framework](../README.md) / [Exports](../modules.md) / SQLRunnerIDGen
...
- [`SQLRunner`](SQLRunner.md)<`TTable`, `void`, `string`\>
...
• **new SQLRunnerIDGen**<`TTable`\>(`schema`, `client`)
...
• `Readonly` **default**: ``"never_happens"``
...
[packages/ent-framework/src/sql/SQLQueryIDGen.ts:34](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/sql/SQLQueryIDGen.ts#L34)
...
[packages/ent-framework/src/sql/SQLQueryIDGen.ts:23](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/sql/SQLQueryIDGen.ts#L23)
...
[packages/ent-framework/src/sql/SQLQueryIDGen.ts:22](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/sql/SQLQueryIDGen.ts#L22)
...
[packages/ent-framework/src/sql/SQLQueryIDGen.ts:49](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/sql/SQLQueryIDGen.ts#L49)

___

### runSingle

▸ **runSingle**(`_input`, `annotations`): `Promise`<`undefined` \| `string`\>
...
[packages/ent-framework/src/sql/SQLQueryIDGen.ts:36](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/sql/SQLQueryIDGen.ts#L36)
