[@time-loop/ent-framework](../README.md) / [Exports](../modules.md) / Configuration
...
• `Readonly` **shardAffinity**: [`ShardAffinity`](../modules.md#shardaffinity)<[`FieldOfIDType`](../modules.md#fieldofidtype)<`TTable`\>, `Exclude`<[`FieldOfIDType`](../modules.md#fieldofidtype)<`TTable`\>, ``"id"``\>\>
