[@clickup/ent-framework](../README.md) / [Exports](../modules.md) / PgQueryLoad
...
- [`QueryBase`](QueryBase.md)\<`TTable`, `string`, [`Row`](../modules.md#row)\<`TTable`\> \| ``null``, [`PgClient`](PgClient.md)\>
