[@time-loop/ent-framework](../README.md) / [Exports](../modules.md) / SQLQueryInsert
...
- [`QueryBase`](QueryBase.md)<`TTable`, [`InsertInput`](../modules.md#insertinput)<`TTable`\>, `string` \| ``null``, [`SQLClient`](SQLClient.md)\>
...
[src/sql/SQLQueryInsert.ts:15](https://github.com/clickup/ent-framework/blob/master/src/sql/SQLQueryInsert.ts#L15)
