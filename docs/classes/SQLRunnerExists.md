[@time-loop/ent-framework](../README.md) / [Exports](../modules.md) / SQLRunnerExists

# Class: SQLRunnerExists<TTable\>
...
- [`SQLRunner`](SQLRunner.md)<`TTable`, [`ExistsInput`](../modules.md#existsinput)<`TTable`\>, `boolean`\>
...
• **new SQLRunnerExists**<`TTable`\>(`schema`, `client`)
...
[src/sql/SQLQueryExists.ts:29](https://github.com/clickup/ent-framework/blob/master/src/sql/SQLQueryExists.ts#L29)
...
[src/sql/SQLQueryExists.ts:22](https://github.com/clickup/ent-framework/blob/master/src/sql/SQLQueryExists.ts#L22)
...
[src/sql/SQLQueryExists.ts:25](https://github.com/clickup/ent-framework/blob/master/src/sql/SQLQueryExists.ts#L25)
...
[src/sql/SQLQueryExists.ts:26](https://github.com/clickup/ent-framework/blob/master/src/sql/SQLQueryExists.ts#L26)
...
[src/sql/SQLQueryExists.ts:27](https://github.com/clickup/ent-framework/blob/master/src/sql/SQLQueryExists.ts#L27)
...
[src/sql/SQLQueryExists.ts:37](https://github.com/clickup/ent-framework/blob/master/src/sql/SQLQueryExists.ts#L37)
...
[src/sql/SQLQueryExists.ts:42](https://github.com/clickup/ent-framework/blob/master/src/sql/SQLQueryExists.ts#L42)
...
| Name | Type |
| :------ | :------ |
| `inputs` | `Map`<`string`, [`ExistsInput`](../modules.md#existsinput)<`TTable`\>\> |
| `annotations` | [`QueryAnnotation`](../interfaces/QueryAnnotation.md)[] |
...
[src/sql/SQLQueryExists.ts:56](https://github.com/clickup/ent-framework/blob/master/src/sql/SQLQueryExists.ts#L56)
