[@slapdash/ent-framework](../README.md) / [Exports](../modules.md) / SQLRunnerSelect

# Class: SQLRunnerSelect<TTable\>
...
- [`SQLRunner`](SQLRunner.md)<`TTable`, [`SelectInput`](../modules.md#selectinput)<`TTable`\>, [`Row`](../modules.md#row)<`TTable`\>[]\>
...
• **new SQLRunnerSelect**<`TTable`\>(`schema`, `client`)
...
[packages/ent-framework/src/sql/SQLQuerySelect.ts:42](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/sql/SQLQuerySelect.ts#L42)
...
[packages/ent-framework/src/sql/SQLQuerySelect.ts:33](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/sql/SQLQuerySelect.ts#L33)
...
[packages/ent-framework/src/sql/SQLQuerySelect.ts:32](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/sql/SQLQuerySelect.ts#L32)
...
[packages/ent-framework/src/sql/SQLQuerySelect.ts:44](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/sql/SQLQuerySelect.ts#L44)
...
| Name | Type |
| :------ | :------ |
| `inputs` | `Map`<`string`, [`SelectInput`](../modules.md#selectinput)<`TTable`\>\> |
| `annotations` | [`QueryAnnotation`](../interfaces/QueryAnnotation.md)[] |
...
[packages/ent-framework/src/sql/SQLQuerySelect.ts:63](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/sql/SQLQuerySelect.ts#L63)

___

### runSingle

▸ **runSingle**(`input`, `annotations`): `Promise`<[`Row`](../modules.md#row)<`TTable`\>[]\>
...
[packages/ent-framework/src/sql/SQLQuerySelect.ts:50](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/sql/SQLQuerySelect.ts#L50)
