[@slapdash/ent-framework](../README.md) / [Exports](../modules.md) / SQLRunnerUpsert
...
- [`SQLRunner`](SQLRunner.md)<`TTable`, [`InsertInput`](../modules.md#insertinput)<`TTable`\>, `string`\>
...
• **new SQLRunnerUpsert**<`TTable`\>(`schema`, `client`)
...
[packages/ent-framework/src/sql/SQLQueryUpsert.ts:36](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/sql/SQLQueryUpsert.ts#L36)
...
[packages/ent-framework/src/sql/SQLQueryUpsert.ts:30](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/sql/SQLQueryUpsert.ts#L30)
...
[packages/ent-framework/src/sql/SQLQueryUpsert.ts:29](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/sql/SQLQueryUpsert.ts#L29)
...
[packages/ent-framework/src/sql/SQLQueryUpsert.ts:69](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/sql/SQLQueryUpsert.ts#L69)
...
| Name | Type |
| :------ | :------ |
| `inputIn` | [`InsertInput`](../modules.md#insertinput)<`TTable`\> |
...
[packages/ent-framework/src/sql/SQLQueryUpsert.ts:73](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/sql/SQLQueryUpsert.ts#L73)

___

### runBatch

▸ **runBatch**(`inputs`, `annotations`): `Promise`<`Map`<`string`, `string`\>\>
...
| Name | Type |
| :------ | :------ |
| `inputs` | `Map`<`string`, [`InsertInput`](../modules.md#insertinput)<`TTable`\>\> |
| `annotations` | [`QueryAnnotation`](../interfaces/QueryAnnotation.md)[] |
...
[packages/ent-framework/src/sql/SQLQueryUpsert.ts:104](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/sql/SQLQueryUpsert.ts#L104)

___

### runSingle

▸ **runSingle**(`input`, `annotations`): `Promise`<`undefined` \| `string`\>
...
[packages/ent-framework/src/sql/SQLQueryUpsert.ts:92](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/sql/SQLQueryUpsert.ts#L92)
