[@clickup/ent-framework](../README.md) / [Exports](../modules.md) / PgQueryCount
...
- [`QueryBase`](QueryBase.md)\<`TTable`, [`CountInput`](../modules.md#countinput)\<`TTable`\>, `number`, [`PgClient`](PgClient.md)\>
