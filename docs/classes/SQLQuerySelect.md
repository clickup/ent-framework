[@time-loop/ent-framework](../README.md) / [Exports](../modules.md) / SQLQuerySelect
...
[src/sql/SQLQuerySelect.ts:17](https://github.com/clickup/rest-client/blob/master/src/sql/SQLQuerySelect.ts#L17)
