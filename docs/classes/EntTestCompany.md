[@slapdash/ent-framework](../README.md) / [Exports](../modules.md) / EntTestCompany

# Class: EntTestCompany

## Hierarchy

- [`HelpersInstance`](../interfaces/HelpersInstance.md)<{ `id`: { `autoInsert`: `string` = "id\_gen()"; `type`: `StringConstructor` = String } ; `name`: { `type`: `StringConstructor` = String }  }, `this`\> & [`RowWithID`](../modules.md#rowwithid) & { `id`: `string` ; `name`: `string`  }
...
BaseEnt(testCluster, schemaTestCompany).constructor
...
BaseEnt(testCluster, schemaTestCompany).id
...
BaseEnt(testCluster, schemaTestCompany).name
...
BaseEnt(testCluster, schemaTestCompany).vc
...
BaseEnt(testCluster, schemaTestCompany).CLUSTER
...
▪ `Static` `Readonly` **Configuration**: (`cfg`: [`Configuration`](Configuration.md)<{ `id`: { `autoInsert`: `string` = "id\_gen()"; `type`: `StringConstructor` = String } ; `name`: { `type`: `StringConstructor` = String }  }\>) => [`Configuration`](Configuration.md)<{ `id`: { `autoInsert`: `string` = "id\_gen()"; `type`: `StringConstructor` = String } ; `name`: { `type`: `StringConstructor` = String }  }\>

#### Type declaration

• **new EntTestCompany**(`cfg`)
...
| Name | Type |
| :------ | :------ |
| `cfg` | [`Configuration`](Configuration.md)<{ `id`: { `autoInsert`: `string` = "id\_gen()"; `type`: `StringConstructor` = String } ; `name`: { `type`: `StringConstructor` = String }  }\> |

#### Inherited from

BaseEnt(testCluster, schemaTestCompany).Configuration
...
▪ `Static` `Readonly` **INVERSES**: [`Inverse`](Inverse.md)<[`TestSQLClient`](TestSQLClient.md), { `id`: { `autoInsert`: `string` = "id\_gen()"; `type`: `StringConstructor` = String } ; `name`: { `type`: `StringConstructor` = String }  }\>[]

Inverse assoc managers for fields.

#### Inherited from

BaseEnt(testCluster, schemaTestCompany).INVERSES
...
▪ `Static` `Readonly` **SCHEMA**: [`Schema`](Schema.md)<{ `id`: { `autoInsert`: `string` = "id\_gen()"; `type`: `StringConstructor` = String } ; `name`: { `type`: `StringConstructor` = String }  }, ``"name"``[]\>

A schema which represents this Ent.

#### Inherited from

BaseEnt(testCluster, schemaTestCompany).SCHEMA
...
BaseEnt(testCluster, schemaTestCompany).SHARD\_AFFINITY
...
BaseEnt(testCluster, schemaTestCompany).SHARD\_LOCATOR
...
▪ `Static` `Readonly` **TRIGGERS**: [`Triggers`](Triggers.md)<{ `id`: { `autoInsert`: `string` = "id\_gen()"; `type`: `StringConstructor` = String } ; `name`: { `type`: `StringConstructor` = String }  }\>

Triggers for this Ent class.

#### Inherited from

BaseEnt(testCluster, schemaTestCompany).TRIGGERS
...
▪ `Static` `Readonly` **VALIDATION**: [`Validation`](Validation.md)<{ `id`: { `autoInsert`: `string` = "id\_gen()"; `type`: `StringConstructor` = String } ; `name`: { `type`: `StringConstructor` = String }  }\>

Privacy rules for this Ent class.

#### Inherited from

BaseEnt(testCluster, schemaTestCompany).VALIDATION
...
BaseEnt(testCluster, schemaTestCompany).deleteOriginal
...
| Name | Type |
| :------ | :------ |
| `input` | [`UpdateInput`](../modules.md#updateinput)<{ `id`: { `autoInsert`: `string` = "id\_gen()"; `type`: `StringConstructor` = String } ; `name`: { `type`: `StringConstructor` = String }  }\> |
...
BaseEnt(testCluster, schemaTestCompany).updateChanged
...
BaseEnt(testCluster, schemaTestCompany).updateOriginal
...
| Name | Type |
| :------ | :------ |
| `TEnt` | extends [`HelpersInstance`](../interfaces/HelpersInstance.md)<{ `id`: { `autoInsert`: `string` = "id\_gen()"; `type`: `StringConstructor` = String } ; `name`: { `type`: `StringConstructor` = String }  }, `TEnt`\> |
...
BaseEnt(testCluster, schemaTestCompany).updateReturningNullable
...
BaseEnt(testCluster, schemaTestCompany).updateReturningX
...
▸ `Static` **configure**(): [`Configuration`](Configuration.md)<{ `id`: { `autoInsert`: `string` = "id\_gen()"; `type`: `StringConstructor` = String } ; `name`: { `type`: `StringConstructor` = String }  }\>

#### Returns

[`Configuration`](Configuration.md)<{ `id`: { `autoInsert`: `string` = "id\_gen()"; `type`: `StringConstructor` = String } ; `name`: { `type`: `StringConstructor` = String }  }\>

#### Overrides

BaseEnt(testCluster, schemaTestCompany).configure

#### Defined in

[packages/ent-framework/src/ent/__tests__/helpers/test-objects.ts:40](https://github.com/time-loop/slapdash/blob/master/packages/ent-framework/src/ent/__tests__/helpers/test-objects.ts#L40)
...
BaseEnt(testCluster, schemaTestCompany).count
...
BaseEnt(testCluster, schemaTestCompany).insert
...
BaseEnt(testCluster, schemaTestCompany).insertIfNotExists
...
BaseEnt(testCluster, schemaTestCompany).insertReturning
...
BaseEnt(testCluster, schemaTestCompany).loadByNullable
...
BaseEnt(testCluster, schemaTestCompany).loadByX
...
BaseEnt(testCluster, schemaTestCompany).loadIfReadableNullable
...
BaseEnt(testCluster, schemaTestCompany).loadNullable
...
BaseEnt(testCluster, schemaTestCompany).loadX
...
BaseEnt(testCluster, schemaTestCompany).select
...
BaseEnt(testCluster, schemaTestCompany).selectChunked
...
BaseEnt(testCluster, schemaTestCompany).upsert
...
BaseEnt(testCluster, schemaTestCompany).upsertReturning
