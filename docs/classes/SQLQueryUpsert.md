[@time-loop/ent-framework](../README.md) / [Exports](../modules.md) / SQLQueryUpsert
...
[src/sql/SQLQueryUpsert.ts:22](https://github.com/clickup/rest-client/blob/master/src/sql/SQLQueryUpsert.ts#L22)
