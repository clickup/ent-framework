[@clickup/ent-framework](../README.md) / [Exports](../modules.md) / SQLRunnerDelete
...
[src/sql/SQLQueryDelete.ts:43](https://github.com/clickup/ent-framework/blob/master/src/sql/SQLQueryDelete.ts#L43)
