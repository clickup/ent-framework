  ...
  expect(
    minifyStack(
      `Error:
        ...
        at /Users/user/slapdash/packages/slapdash-server/src/lib/connectors/asana/AsanaDriver.ts:256:32
        ...
        at loadProjects (/Users/user/slapdash/packages/slapdash-server/src/lib/connectors/asana/AsanaDriver.ts:255:11)`,
      1
    )
  ).toMatchSnapshot();
});
